...
abstract class Model {
    ...
    protected $db;     // Mantém o Database
    protected $pdo;    // Adiciona acesso ao PDO
    ...
    public function __construct() {
        ...
        $this->db = $database;                  // Mantemos a referência ao Database
        $this->pdo = $database->getConnection(); // E adicionamos acesso ao PDO
    }
