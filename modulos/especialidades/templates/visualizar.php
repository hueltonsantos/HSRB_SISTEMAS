                        ...
                        <div class="col-md-12">
                            <div class="info-box mb-4">
                                <?php if (empty($procedimentos)): ?>
                                    ...
                                    <a href="index.php?module=especialidades&action=add_procedimento&especialidade_id=<?php echo $especialidade['id']; ?>"
                                        class="btn btn-info btn-sm">
                                ...
                                <div class="col mr-2">
                                    ...
                                    <div class="mb-0 font-weight-bold text-gray-800">
                                        ...
                                        <p class="text-secondary">
                                            <?php echo isset($especialidade['data_cadastro_formatada']) ? $especialidade['data_cadastro_formatada'] : ''; ?>
                                        </p>
                                    </div>
                                </div>
                                <div class="col-auto">
                                    ...
                                    <div class="mb-0 mt-3">
                                        ...
                                        <?php if (!empty($procedimentos)): ?>
                                            ...
                                            foreach ($procedimentos as $proc) {
                                                // Usa valor_paciente ou 0 se não existir
                                                $valor = isset($proc['valor_paciente']) ? $proc['valor_paciente'] : 0;
                                                $totalValores += $valor;
                                            ...
                                            <p class="text-success">
                                                <?php echo $valorProcedimentoModel->formatDecimalToCurrency($mediaValor); ?>
                                            </p>

                                            <p class="font-weight-bold mt-2">Valor mínimo:</p>
                                            <p class="text-info">
                                                <?php echo $valorProcedimentoModel->formatDecimalToCurrency($minValor); ?>
                                            </p>

                                            <p class="font-weight-bold mt-2">Valor máximo:</p>
                                            <p class="text-primary">
                                                <?php echo $valorProcedimentoModel->formatDecimalToCurrency($maxValor); ?>
                                            </p>
                                        <?php endif; ?>
                                    </div>
                                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Deseja realmente excluir a especialidade
                    <strong><?php echo htmlspecialchars($especialidade['nome']); ?></strong>?</p>
                ...
                <form id="deleteForm" action="index.php?module=especialidades&action=delete" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio">
                            <input type="radio" id="logica" name="tipo_exclusao" class="custom-control-input"
                                value="logica" checked>
                            <label class="custom-control-label" for="logica">
                                Desativar (exclusão lógica)
                            </label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input type="radio" id="fisica" name="tipo_exclusao" class="custom-control-input"
                                value="fisica">
                ...
                <div class="alert alert-warning mt-3">
                    ...
                    <small>A exclusão física só será possível se não houver procedimentos ou clínicas vinculadas a esta
                        especialidade.</small>
                </div>
            </div>
