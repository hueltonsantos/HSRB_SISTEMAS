                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <p class="mb-0 text-dark">
                                ...
                                <strong
                                    class="text-dark"><?= !empty($agendamento['paciente_nome']) ? htmlspecialchars($agendamento['paciente_nome']) : '<span class="text-muted">N/A</span>' ?></strong>
                            </p>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <p class="mb-0 text-dark">
                                ...
                                <strong
                                    class="text-dark"><?= !empty($agendamento['data_consulta']) ? date('d/m/Y', strtotime($agendamento['data_consulta'])) : '<span class="text-muted">N/A</span>' ?></strong>
                                <span class="mx-2 text-dark">|</span>
                                <i class="fas fa-clock text-primary mr-1"></i>
                                <strong
                                    class="text-dark"><?= !empty($agendamento['hora_consulta']) ? date('H:i', strtotime($agendamento['hora_consulta'])) : '<span class="text-muted">N/A</span>' ?></strong>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <p class="mb-0 text-dark">
                                ...
                                <span
                                    class="text-dark"><?= !empty($agendamento['especialidade_nome']) ? htmlspecialchars($agendamento['especialidade_nome']) : '<span class="text-muted">N/A</span>' ?></span>
                            </p>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="font-weight-bold text-gray-600">Procedimento(s)</label>
                            <?php if (!empty($agendamento['procedimentos_lista'])): ?>
                                <ul class="list-unstyled mb-0">
                                    <?php foreach ($agendamento['procedimentos_lista'] as $proc): ?>
                                        <li class="text-dark">
                                            <i class="fas fa-procedures text-info mr-1"></i>
                                            <?= htmlspecialchars($proc['procedimento']) ?>
                                            <?php if (!empty($proc['valor']) && $proc['valor'] > 0): ?>
                                                <small class="text-muted">(R$
                                                    <?= number_format($proc['valor'], 2, ',', '.') ?>)</small>
                                            <?php endif; ?>
                                        </li>
                                    <?php endforeach; ?>
                                </ul>
                            <?php else: ?>
                                <p class="mb-0 text-dark">
                                    <i class="fas fa-procedures text-info mr-1"></i>
                                    <span
                                        class="text-dark"><?= !empty($agendamento['procedimento_nome']) ? htmlspecialchars($agendamento['procedimento_nome']) : '<span class="text-muted">N/A</span>' ?></span>
                                </p>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <p class="mb-0 text-dark">
                                ...
                                <span
                                    class="text-dark"><?= !empty($agendamento['profissional_nome']) ? htmlspecialchars($agendamento['profissional_nome']) : '<span class="text-muted">N/A</span>' ?></span>
                            </p>
                        </div>
                        <div class="col-md-6 mb-3">
                            <?php if (!empty($agendamento['convenio_id'])): ?>
                                <label class="font-weight-bold text-gray-600">Convênio</label>
                                <p class="mb-0 text-dark">
                                    <i class="fas fa-notes-medical text-primary mr-1"></i>
                                    <span
                                        class="text-dark"><?= !empty($agendamento['convenio_nome']) ? htmlspecialchars($agendamento['convenio_nome']) : '<span class="text-muted">N/A</span>' ?></span>
                                </p>
                            <?php else: ?>
                                ...
                                <p class="mb-0 text-dark">
                                    ...
                                    <span
                                        class="text-dark"><?= !empty($agendamento['forma_pagamento']) ? htmlspecialchars($agendamento['forma_pagamento']) : '<span class="text-muted">N/A</span>' ?></span>
                                </p>
                            <?php endif; ?>
                        </div>
                    </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="d-flex flex-wrap gap-2">
                        <button type="button" class="btn btn-primary btn-sm mb-2 mr-2 btn-status" data-status="agendado"
                            data-id="<?= $agendamento['id'] ?>">
                            <i class="fas fa-calendar"></i> Agendado
                        </button>
                        <button type="button" class="btn btn-info btn-sm mb-2 mr-2 btn-status" data-status="confirmado"
                            data-id="<?= $agendamento['id'] ?>">
                        ...
                        <button type="button" class="btn btn-warning btn-sm mb-2 mr-2 btn-status" data-status="faltou"
                            data-id="<?= $agendamento['id'] ?>">
                            <i class="fas fa-user-slash"></i> Faltou
                        </button>
                        <button type="button" class="btn btn-danger btn-sm mb-2 btn-status" data-status="cancelado"
                            data-id="<?= $agendamento['id'] ?>">
            ...
            <?php if (!empty($agendamento['paciente_celular'])): ?>
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body text-center">
                        ...
                        ?>
                        <a href="https://wa.me/<?= $celular ?>?text=<?= $msg ?>" target="_blank"
