        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Prod. Convênio Hoje
                            </div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">R$
                                <?= number_format($estatisticasHoje['faturamento_convenio'] ?? 0, 2, ',', '.') ?></div>
                        </div>
                        <div class="col-auto">
...
<<<<<<< HEAD
                        ...
                        <div class="col-3">
                            <h4 class="text-warning">R$
                                <?= number_format($estatisticasMes['faturamento'] ?? 0, 2, ',', '.') ?></h4>
